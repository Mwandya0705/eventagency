...
export default function BigFooter() {
  return (
    ...
    >
      {/* ── Bottom links & copyright — compact on mobile, taller on large screens ── */}
      <div className="px-6 md:px-12 py-8 lg:py-20 xl:py-28">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8 lg:gap-12">

          {/* Brand */}
          <h2 className="font-display text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-black uppercase tracking-tighter text-white leading-none">
            PAMEDIA
          </h2>
        ...
        {/* Copyright bar */}
        <div className="max-w-7xl mx-auto mt-6 lg:mt-16 xl:mt-24 pt-5 lg:pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-[10px] text-white/35 font-mono tracking-wider">
